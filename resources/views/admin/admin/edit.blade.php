                            ...
                            <form method="POST" action="">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <p style="color: red">If you wanna change the password*</p>
                                    </div>
                                    <br><br>
                                    <div class="form-group">
                                        <label><i class="fas fa-gavel"></i> Promote / Demote Menu</label>
                                        <br>
                                        <label>
                                            <input type="radio" name="user_type" value="3"
                                                {{ $getRecord->user_type == 3 ? 'checked' : '' }}>
                                            Promote as SuperAdmin Assistant
                                        </label>
                                        <br>
                                        <label>
                                            <input type="radio" name="user_type" value="1"
                                                {{ $getRecord->user_type == 1 ? 'checked' : '' }}>
                                            Demote to Admin
                                        </label>
                                    </div>
                                </div>
