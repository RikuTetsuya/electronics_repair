            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6" style="text-align: right">
                        <a href="{{ url('admin/admin/add') }}" class="btn btn-primary"><i class="fas fa-plus"></i> New
                            Admin</a>
                    </div>
                </div><!-- /.container-fluid -->
        </section>
                                        ...
                                        @foreach ($getRecord as $val)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ url('admin/admin/deactivate/' . $val->id) }}"
                                                        class="btn btn-xs btn-danger" title="Deactivate"><i
                                                            class="fa fa-power-off"></i></a>
                                                </td>
                                                <td>
                                                    <form action="{{ url('delete_admin/' . $val->id) }}" method="POST">
                                                        @csrf
                                                        <a class="delete-confirm btn btn-xs btn-warning" title="Delete"><i
