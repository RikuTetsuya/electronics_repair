                            ...
                            <form method="POST" action="{{ url('admin/service_in/update/' . $reportins->id) }}">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <p>{{ \Carbon\Carbon::parse($reportins->tanggal_masuk)->translatedFormat('d-F-Y') }}
                                        </p>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-control" value="{{ $reportins->status }}">
                                            <option value="0" {{ $reportins->status == 0 ? 'selected' : '' }}>
                                                Waiting...</option>
                                            <option value="1" {{ $reportins->status == 1 ? 'selected' : '' }}>Rejected
                                            </option>
                                            <option value="2" {{ $reportins->status == 2 ? 'selected' : '' }}>Accepted
                                            </option>
                                            <option value="3" {{ $reportins->status == 3 ? 'selected' : '' }}>On
                                                Process...</option>
                                            <option value="4" {{ $reportins->status == 4 ? 'selected' : '' }}>Finished
                                            </option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <p>Rp. </p>
                                        <input type="number" name="harga" value="{{ $reportins->harga }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status_payment" id="status_payment" class="form-control" required>
                                            <option value="Unpaid"
                                                {{ old('status_payment', $serviceIn->status_payment ?? '') == 'Unpaid' ? 'selected' : '' }}>
                                                Unpaid</option>
                                            <option value="Paid" disabled
                                                {{ old('status_payment', $serviceIn->status_payment ?? '') == 'Paid' ? 'selected' : '' }}>
                                                Paid</option>
                                            <option value="Paid in Cash"
                                                {{ old('status_payment', $serviceIn->status_payment ?? '') == 'Paid in Cash' ? 'selected' : '' }}>
                                                Paid in Cash</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="perbaikan_pihak_ketiga" class="form-control"
                                            value="{{ $reportins->perbaikan_pihak_ketiga }}">
                                            <option value="0"
                                                {{ $reportins->perbaikan_pihak_ketiga == 0 ? 'selected' : '' }} disabled>
                                                Waiting...</option>
                                            <option value="1"
                                                {{ $reportins->perbaikan_pihak_ketiga == 1 ? 'selected' : '' }}>Ya</option>
                                            <option value="2"
                                                {{ $reportins->perbaikan_pihak_ketiga == 2 ? 'selected' : '' }}>Tidak
                                            </option>
                                        </select>
                                    </div>
                                </div>
