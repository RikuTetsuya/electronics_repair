        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6" style="text-align: right">
                    <button disabled href="{{ url('customer/order/add') }}" class="btn btn-primary"><i class="fas fa-cart-plus"></i> Order</button>
                </div>
            </div>
        </div>
    </section>
                                    ...
                                    <div class="card mb-3 customer-card" data-customer-name="{{ strtolower($val->nama_customer) }}" data-service-name="{{ strtolower($val->nama_layanan) }}" data-status="{{ $val->status }}">
                                        <div class="card-body">
                                          ...
                                          @endif                                        
                                            ...
                                            <a href="{{ url('admin/service_in/edit/' . $val->id) }}" class="btn btn-xs btn-primary">
                                              <i class="fa fa-pencil-alt"></i> Edit
                                            </a>

                                            <form action="{{ url('delete_service_in/' . $val->id) }}" method="POST" style="display:inline;">
                                              @csrf
