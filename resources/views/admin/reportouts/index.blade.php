            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6" style="text-align: right">
                        <a href="{{ url('admin/service_out/add') }}" class="btn btn-primary"><i class="fas fa-plus"></i> New
                            Service</a>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="card mb-3 customer-card"
                                            ...
                                            <div class="card-body">
                                                <h5 class="card-title mb-2">
                                                    <i class="fas fa-tag"></i> {{ $val->name }}'s order
                                                ...
                                                <p class="card-text"><i class="fas fa-calendar-minus"></i> <strong>Tanggal
                                                        Keluar:</strong>
                                                    {{ $val->tanggal_keluar ? \Carbon\Carbon::parse($val->tanggal_keluar)->translatedFormat('d-F-Y') : '- (belum diperkirakan)' }}
                                                </p>
                                                <p class="card-text"><i class="fas fa-calendar-check"></i> <strong>Tanggal
                                                        Kembali:</strong>
                                                    {{ $val->tanggal_diterima ? \Carbon\Carbon::parse($val->tanggal_diterima)->translatedFormat('d-F-Y') : '- (barang belum kembali)' }}
                                                </p>
                                                ...
                                                <button class="btn btn-xs btn-info view-detail" data-toggle="modal"
                                                    ...
                                                    data-telepon="{{ $val->telepon }}" data-email="{{ $val->email }}"
                                                    data-alamat="{{ $val->alamat }}"
                                                    data-keluhan="{{ $val->deskripsi_masalah }}" {{-- data-serviceins-note="{{ $val->catatan }}" --}}
                                                ...
                                                <a href="{{ url('admin/service_out/edit/' . $val->id) }}"
                                                    class="btn btn-xs btn-primary">
                                                    <i class="fa fa-pencil-alt"></i> Edit
                                                </a>

                                                <form action="{{ url('delete_service_out/' . $val->id) }}" method="POST"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="viewModalLabel"><i class="fas fa-tag"></i> <span
                            id="modal-customer-name-title"></span>'s Order Detail</h5>
