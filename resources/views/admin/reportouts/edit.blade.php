              ...
              <form method="POST" action="{{ url('admin/service_out/update/' . $reportouts->id) }}">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="tanggal_keluar" value="{{ \Carbon\Carbon::parse($reportouts->tanggal_keluar)->format('d-m-Y') }}" disabled>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <p>Rp. </p>
                    <input type="number" name="biaya" value="{{ $reportouts->biaya }}" class="form-control" step="0.01">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <select name="status" class="form-control">
                      <option value="0" {{ $reportouts->status == 0 ? 'selected' : '' }}>Waiting...</option>
                      <option value="1" {{ $reportouts->status == 1 ? 'selected' : '' }}>On Process...</option>
                      <option value="2" {{ $reportouts->status == 2 ? 'selected' : '' }}>Finished</option>
                    </select>
                  </div>
                </div>
                <!-- /.card-body -->
