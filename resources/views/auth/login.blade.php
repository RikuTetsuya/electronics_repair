...
<head>
    ...
    <style>
        ...
        html {
            ...
            align-items: center;
            background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('https://pbs.twimg.com/media/DUIc6eUXUAAxk_n?format=jpg&name=medium') no-repeat center center/cover;
            /* background: gray; */
            ...
            <label class="switch">
                ...
                <div class="flip-card__inner">
                    ...
                    <div class="flip-card__back">
                        ...
                        @include('_message')
                        <form class="flip-card__form" action="{{ url('signup/insert') }}" method="post">
                          @csrf
